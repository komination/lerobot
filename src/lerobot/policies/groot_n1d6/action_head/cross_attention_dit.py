...
"""Diffusion Transformer (DiT) modules for GR00T N1.6."""
...
class TimestepEncoder(nn.Module):
    """Encodes timesteps into embeddings for the diffusion process."""
...
class BasicTransformerBlock(nn.Module):
    """Basic transformer block with self-attention, cross-attention, and feed-forward layers."""
...
class DiT(ModelMixin, ConfigMixin):
    """Diffusion Transformer model for action generation."""
...
class AlternateVLDiT(DiT):
    """Alternate Vision-Language DiT that separates image and non-image tokens during cross-attention.

    This is the main DiT variant used in GR00T N1.6, featuring alternating attention
    between image and text tokens for improved multimodal understanding.
    """
    ...
    def forward(
        ...
        assert image_mask is not None, "Image mask is required for AlternateVLDiT"
